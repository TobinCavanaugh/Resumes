...
#v(-2pt)
- Debugged and assisted in the development of an automation program for the 787 Mid Body Join to be installed at the Boeing Charleston assembly plant. The process involved collaboration with both developers and engineers.
...
#grid(
  ...
  // [#h(0pt)],
  // [#h(0pt)],
  align(right)[*Spring 2023*],
)

#v(-2pt)
- Created a fully-fledged game in Unity, a cohesive, Ghibli-like style and nine unique environments.
- Made aesthetically pleasing art assets and animations using Blender, resulting in a beautiful and highly performant game that stays at a constant 60fps.
